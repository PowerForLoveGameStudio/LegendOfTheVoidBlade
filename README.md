...
游戏系统 - 刘以清、王逸之<br/>
建模和界面设计 - 李晨阳、张昊昱<br/>
玩家设置和基本反应逻辑 - 曲怡静、王明扬、王逸之<br/>

**任务分配**

游戏系统 - 显示、画面、音量、控制、游戏设置（时间待定）<br/>
建模和界面设计 - 确认序章中所有场景的风格（2天）、去虚幻商城找合适的素材（1天）、对简单的对象进行建模（3天）<br/>
玩家设置和基本反应逻辑 - 玩家移动以及移动姿势控制（2天）、基本反应逻辑的伤害计算（4天）<br/>
