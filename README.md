...
**策划（Game Design）**：<br/>
     ...
     - 关卡策划（地图/任务设计）```曲怡静、Mike、李晨阳```<br/>
     - 剧情策划（世界观/叙事设计）```Mike```<br/>

**程序（Engineering）**：<br/>
     - 客户端开发（Unity/Unreal引擎）```刘以清、曲怡静、王明扬、王逸之、李晨阳```<br/>
     - 技术美术（TA）/图形程序（渲染优化）<br/>

**美术（Art）**：<br/>
     - 原画（概念设计）<br/>
     - 2D/3D美术（角色/场景建模）```刘以清、曲怡静、Mike```<br/>
     - 动画（动作/特效）<br/>
     - UI/UX（界面交互设计）```Mike、李晨阳、曲怡静```<br/>

**音频（Audio）**：背景音乐、音效、配音。```王逸之、李晨阳```<br/>
