...
```
6. 🌑影 *Shadow*（属性：隐形）此属性为**影族**特殊属性<br/>
- 元素特性：此属性无法被克制或克制任何属性，可与🪙金，🌊水属性产生反应<br/>
- 典型载体：黑雾，幽暗废墟，噩梦空间，隐匿型魔物<br/>
- 武器效果：```蚀刃```：攻击命中敌人后施加**影蚀**状态，缓慢**侵蚀**其护甲值并造成精神干扰，处于**潜行状态**的第一次攻击必定**暴击**<br/>
- 护甲效果：```潜行```：在非战斗状态下进入**潜行状态**（敌人识别距离降低），身体处于半透明状态<br/>
- 弹反效果：```暗击```：完美弹反后角色瞬间**隐身**一小段时间并进入**潜行状态**<br/>
- 典型应用：<br/>
```

```
7. ✨以太 *Ether*（属性：灵能）<br/>
- 元素特性：此属性**无法被克制或克制任何属性**，也无法产生任何元素反应，处于**系统外**的独立能量，是对现有元素体系的**绝对中立与否定**<br/>
- 典型载体：灵能使，主角内在意志投影，最终BOSS<br/>
- 武器效果：<br/>
- 护甲效果：<br/>
- 弹反效果：<br/>
- 典型应用：<br/>
...
```
8. 🩸血 *Blood*（属性：渴求）此属性为**血魔族**特殊属性<br/>
- 元素特性：此属性为**血魔族**专属的隐藏属性，常见于古老文明中被封印的**血月怪物**身上，仅出现在**特殊区域**<br/>
- 典型载体：血魔战士、血祭法师、献祭主教、血月BOSS<br/>
- 武器效果：<br/>
- 护甲效果：<br/>
- 弹反效果：<br/>
- 典型应用：<br/>
